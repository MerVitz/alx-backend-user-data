...
class BasicAuth:
    ...
    def extract_user_credentials(self, decoded_base64_authorization_header: str) -> Tuple[str, str]:
        ...
        Returns:
            Tuple[str, str]: The user email and password, or (None, None) if invalid.
        """
    ...
    def user_object_from_credentials(self, user_email: str, user_pwd: str) -> TypeVar('User'):
        ...
        Returns:
            User: The user instance if credentials are valid, or None if invalid.
        """
        if not isinstance(user_email, str) or not isinstance(user_pwd, str):
            return None

        # Search for the user using the class method `search` from the User model
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        decoded_header = self.decode_base64_authorization_header(authorization_header)
