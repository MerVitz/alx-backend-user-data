...
class BasicAuth:
    ...
    an authorization header and retrieve the corresponding user from the database.
    """
    ...
    def extract_user_credentials(self, decoded_base64_authorization_header: str) -> (str, str):
        """
        Extracts the user credentials (email and password) from the decoded Base64 
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        Returns:
            User: The user object if authentication is successful, or None if not authenticated.
        """
        if request is None:
            return None
